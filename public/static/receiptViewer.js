...
<body>
  ...
  <div class="arc-rcpt-header">
    ...
    <p>ARC AI Agents · Arc Testnet · ${_arcEsc(dateStr)}</p>
    ${_arcBadge(r.status)}
  </div>
  ...
  <div class="arc-rcpt-footer">
    Generated by ARC AI Agents &middot; testnet.arcscan.app &middot; Testnet only<br>
...
<body>
  ...
  <div class="arc-rcpt-header">
    ...
    <p>ARC AI Agents · Arc Testnet · Trustless Escrow</p>
