...
(function () {
  ...
  function chainLogo(key, size) {
    const s = size || 34;
    // Arc: official Arc mark (self-hosted official asset — never recreated)
    if (key === 'arc') return `<span class="xb-logo" style="width:${s}px;height:${s}px;"><img src="/static/arc-mark-256.png" alt="Arc" style="width:100%;height:100%;object-fit:cover;display:block;" loading="lazy"></span>`;
    const svg = CHAIN_LOGOS[key];
  ...
  function injectStyle() {
    ...
    st.textContent = `
      ...
      @media (max-width:1400px){ #tab-content-xbridge .xb-card{flex:0 1 auto;width:auto;max-width:440px;} }
      @media (max-width:1280px){ #tab-content-xbridge .xb-primary{flex-wrap:wrap;justify-content:center;} #tab-content-xbridge .xb-card{width:100%;max-width:480px;} }
    ...
    root.innerHTML = `
      <div class="xb">
        ...
        <div class="xb-main">
          ...
          <div class="xb-side">
            <div class="xb-panel"><p class="xb-sec-t"><i class="fas fa-link" style="color:#60b4ff;"></i>Supported Chains</p><div id="xb-chains"></div><div style="display:flex;align-items:center;gap:6px;margin-top:10px;padding-top:9px;border-top:1px solid rgba(96,180,255,0.10);"><span style="font-size:10px;color:#5f7ba0;">Available on</span><img src="/static/arc-logo-ondark.svg" alt="Arc" style="height:11px;width:auto;display:block;opacity:.85;" loading="lazy"></div></div>
