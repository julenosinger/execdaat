 ...
 * 
 * Exports the main dApp HTML page as a function.
 * NO Cloudflare Workers dependencies — safe to import in Node.js (Vercel).
 * AUTO-GENERATED from src/index.tsx — do not edit manually.
 */
...
<head>
  ...
  <meta name="classification" content="Development/Testing Tool">
  <meta name="category" content="testnet, web3, blockchain, development">
            ...
            <div class="lg:col-span-2 space-y-4">
              ...
              <div class="bg-gray-900/60 border border-gray-800/60 rounded-2xl p-5">
                ...
                <div class="space-y-3">
                  ...
                  ].map(([n,title,desc,color]) => '<div class="flex items-start gap-3"><div class="w-6 h-6 rounded-full bg-'+color+'-900/40 border border-'+color+'-700/40 flex items-center justify-center text-'+color+'-400 text-[10px] font-bold flex-shrink-0 mt-0.5">'+n+'</div><div><div class="text-white text-xs font-semibold">'+title+'</div><div class="text-gray-600 text-[10px]">'+desc+'</div></div></div>').join('')}
                </div>
              </div>
